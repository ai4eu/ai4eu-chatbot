...
import go_bot.ChatBot as bot

app = Sanic("AI4EU Goal-oriented ChatBot Service")
...
"""
"""
def bad_input(error, service="AI4EU Goal-oriented ChatBot"):
    """
    ...
    return json(
                ...
                headers={'X-Served-By': 'AI4EU Goal-oriented ChatBot'},
                status=400)
            ...
            return json(
                {
                    'results': results,
                    'model': model,
                    'service': 'AI4EU Goal-oriented ChatBot'
                },
                headers={'X-Served-By': 'AI4EU Goal-oriented ChatBot'},
                status=200)
        else:
